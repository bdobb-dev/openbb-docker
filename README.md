...
curl -u openbb:<password> https://openbb.<your-tailnet>.ts.net/apps.json                   # 200 — the example dashboards, one per bdobb episode (workspace_apps.json, written by bdobb-v2's pnpm apps:sync)
